...
class DespachoPolicy
{
    ...
    {
        return $user->can('view_any_despacho');
    }
    ...
    {
        return $user->can('create_despacho');
    }
    ...
    {
        return $user->can('update_despacho');
    }
    ...
    {
        return $user->can('delete_despacho');
    }
    ...
    {
        return $user->can('restore_despacho');
    }
    ...
    {
        return $user->can('force_delete_despacho');
    }
}
