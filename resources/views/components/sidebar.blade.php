<nav class="sb-sidenav accordion sb-sidenav-light shadow-sm bg-white" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            <a class="nav-link {{ request()->routeIs('home') || request()->routeIs('gestion.*') ? 'active bg-light' : '' }}"
                href="{{ route('home') }}">
                <div class="sb-nav-link-icon"><i class="fa-solid fa-house fa-fw me-2"></i></div>
                Vehículos
            </a>
            <a class="nav-link {{ request()->routeIs('trabajos.asignar') ? 'active bg-light' : '' }}"
                href="{{ route('trabajos.asignar') }}">
            ...
            <a class="nav-link {{ request()->routeIs('articulos') ? 'active bg-light' : '' }}"
                href="{{ route('articulos') }}">
                <div class="sb-nav-link-icon"><i class="fa-solid fa-box-archive fa-fw me-2"></i></div>
                Artículos
            </a>
            <a class="nav-link {{ request()->routeIs('consulta.*') ? 'active bg-light' : '' }}"
                href="{{ route('consulta.vehicular') }}">
            ...
            <a class="nav-link {{ request()->routeIs('maletas.*') ? 'active bg-light' : '' }}"
                href="{{ route('maletas.index') }}">
                <div class="sb-nav-link-icon"><i class="fa-solid fa-toolbox fa-fw me-2"></i></div>
                Mis Maletas
            </a>
        </div>
    </div>
