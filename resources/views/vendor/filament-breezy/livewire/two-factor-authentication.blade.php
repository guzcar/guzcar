<x-filament-breezy::grid-section md=3 :title="__('filament-breezy::default.profile.2fa.title')" :description="__('filament-breezy::default.profile.2fa.description')">
    ...
    <x-filament::card>
        ...
        @unless ($user->hasEnabledTwoFactor())
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('filament-breezy::default.profile.2fa.not_enabled.description') }}</p>
        ...
        @else
            @if ($user->hasConfirmedTwoFactor())
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('filament-breezy::default.profile.2fa.enabled.description') }}</p>
            ...
            @else
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('filament-breezy::default.profile.2fa.finish_enabling.description') }}</p>
